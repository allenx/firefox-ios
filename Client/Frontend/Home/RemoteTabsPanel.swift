...
class RemoteTabsPanel: UIViewController, HomePanel {
    ...
    override func viewDidLoad() {
        ...
        tableViewController.setUpTableViewControllerForHomePanel()
...
private class RemoteTabsTableViewController : UITableViewController {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        refreshControl?.addTarget(self, action: #selector(RemoteTabsTableViewController.SELrefreshTabs), forControlEvents: .ValueChanged)
        refreshTabs()
    }

    override func viewDidDisappear(animated: Bool) {
        super.viewDidDisappear(animated)
        refreshControl?.removeTarget(self, action: #selector(RemoteTabsTableViewController.SELrefreshTabs), forControlEvents: .ValueChanged)
    }
    ...
    func setUpTableViewControllerForHomePanel() {
