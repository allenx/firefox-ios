...
class StringSetting: Setting, UITextFieldDelegate {
    ...
    init(prefs: Prefs, prefKey: String, defaultValue: String? = nil, placeholder: String? = nil, accessibilityIdentifier: String? = nil, settingIsValid isValueValid: ((String?) -> Bool)? = nil, settingDidChange: ((String?) -> Void)? = nil) {
        self.prefs = prefs
        self.prefKey = prefKey
        self.defaultValue = defaultValue
        self.settingDidChange = settingDidChange
...
class ButtonSetting: Setting {
    ...
    init(title: NSAttributedString?, destructive: Bool = false, accessibilityIdentifier: String? = nil, isEnabled: () -> Bool = ButtonSetting.always, onClick: (UINavigationController?) -> ()) {
